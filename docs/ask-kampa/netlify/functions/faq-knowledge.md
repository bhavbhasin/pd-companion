...
This is the knowledge base for "Ask Kampa." Derived from Kampa-FAQ.md with [SHIP-GATED] entries removed (the bot must never describe unshipped features). Regenerate from the canonical Kampa-FAQ.md when it changes.
