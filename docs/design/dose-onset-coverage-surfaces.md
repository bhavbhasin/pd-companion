...
2. **The at-least floors need a rule.** The 07-27 01:13 dose reads *"coverage at least 1 min"*, which
   tells the reader nothing. Same family as the medication card's *"up to about 10 min"*, which is
   still open — settle both together.
3. **What counts as a day.** The 00:47 and 01:13 doses belong to the previous evening's run; calendar
